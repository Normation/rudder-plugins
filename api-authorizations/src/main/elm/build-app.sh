...
elm-${ELM_VER} make --optimize sources/ApiAuthorizations.elm --output=generated/api-authorizations.js
elm-${ELM_VER} make --optimize sources/UserApiToken.elm --output=generated/user-api-token.js
