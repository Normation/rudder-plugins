...
PLUGINS = api-authorizations auth-backends branding change-validation datasources helloworld node-external-reports scale-out-relay user-management vault glpi centreon notify
