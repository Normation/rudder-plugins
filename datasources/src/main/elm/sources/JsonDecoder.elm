    ...
    string
        |> andThen
            (\s ->
                case s of
                    "notscheduled" ->
                        succeed NotScheduled

                    "scheduled" ->
                        succeed Scheduled

                    _ ->
                        fail "Data Source schedule must be 'scheduled/notscheduled'"
            )
        ...
        |> andThen
            (\s ->
                case s of
                    ...
                    _ ->
                        fail "Data Source http method must be 'get/post'"
            )
        ...
        |> andThen
            (\s ->
                case s of
                    ...
                    _ ->
                        fail "Data Source http request mode must be 'byNode/allNodes'"
            )
        ...
        |> andThen
            (\s ->
                case s of
                    ...
                    _ ->
                        fail "Data Source on missing data behavior must be 'delete/noChange/defaultValue'"
            )
        ...
        |> andThen
            (\s ->
                case s of
                    ...
                    _ ->
                        fail "Data Source type must be 'http'"
            )
