...
newDataSource =
    DataSource "" "" "" True (5 * 60) (RunParameters False False (Schedule Scheduled 30)) (HTTP (HTTPType "" GET "" True [] 30 [] ByNode 10 Delete))
        ...
        SaveCall d ->
            let
                ...
                hasError =
                    case d.type_ of
                        HTTP tpe ->
                            String.isEmpty d.name || String.isEmpty id || String.isEmpty tpe.url
            ...
            if hasError then
                ...
                case model.mode of
                    ...
                    ShowDatasource _ (Just _) ->
                        ( { model
                            | dataSources =
                                if List.any (\dts -> dts.id == updated.id) listDatasources then
                                    listDatasources

                                else
                                    updated :: listDatasources
                          }
