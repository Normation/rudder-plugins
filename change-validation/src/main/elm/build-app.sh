...
elm-${ELM_VER} make --optimize sources/SupervisedTargets.elm --output=generated/supervised-targets.js
elm-${ELM_VER} make --optimize sources/WorkflowUsers.elm --output=generated/WorkflowUsers.js
