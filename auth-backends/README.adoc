...
rudder.auth.oauth2.provider.keycloak.roles.mapping.entitlements.rudder_readonly=read_only
...
# And here, we map the IdP role "name=Alice,ou=users" to Rudder role "read_only"
#rudder.auth.oauth2.provider.keycloak.roles.mapping.reverseEntitlements.read_only=name=Alice,ou=users
